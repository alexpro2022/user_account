...
from toolkit.api.fastapi.responses import response_400_already_exists, response_404
...
from ..dependencies import admin, current_user
...
@router.get(
    "/{user_id}",
    summary="get user",
    # description=service.get.__doc__,
    response_model=schemas.UserOut,
    responses=response_404("user"),
